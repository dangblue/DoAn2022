...
<!-- //font-awesome icons -->
<script src="{{url('public/backtend')}}/js/jquery2.0.3.min.js"></script>
</head>
<body>
<div class="log-w3">
...
<script src="{{url('public/backtend')}}/js/bootstrap.js"></script>
<script src="{{url('public/backtend')}}/js/jquery.dcjqaccordion.2.7.js"></script>
<script src="{{url('public/backtend')}}/js/scripts.js"></script>
<script src="{{url('public/backtend')}}/js/jquery.slimscroll.js"></script>
<script src="{{url('public/backtend')}}/js/jquery.nicescroll.js"></script>
<!--[if lte IE 8]><script language="javascript" type="text/javascript" src="/js/flot-chart/excanvas.min.js"></script><![endif]-->
<script src="{{url('public/backtend')}}/js/jquery.scrollTo.js"></script>
</body>
</html>
